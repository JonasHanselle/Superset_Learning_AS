...
# This code is largely built upon the PerAlgorithmRegressor 

class MLPRegressor:

    def __init__(self, impute_censored=False, loss_function="superset"):
        self.logger = logging.getLogger("superset_regressor_mlp")
        ...
        print("CREATED MLP REGRESSOR " + str(self.impute_censored))
    ...
    def fit(self, scenario: ASlibScenario, fold: int, amount_of_training_instances: int):
        ...
        for algorithm_id in range(self.num_algorithms):
            ...
            model = NeuralNetworkGLM(seed=fold, cutoff=scenario.algorithm_cutoff_time, loss_function=self.loss_function, hidden_layer_sizes=[],num_epochs=5000)
    ...
    def get_name(self):
        ...
        if self.impute_censored:
            name += 'imputed_'
        return name+f'{self.loss_function}_mlp'
